...
public class LocalizedStrings {
    ...
    public static final String MOVEMENT_RESTRICTION = "Движение запрещёно сервером битвы";
    public static final String NEW_CLINET_BATTLE_LOGIN = "Новый пользователь вошёл в битву ";

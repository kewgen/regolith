...
public class SerializerTest {
    ...
    public void before() {
        ...
        ServerBorderCollection borderDictionary = new ServerBorderCollection();
        borderDictionary.setBorders(Arrays.asList(borders));
        baseConfiguration.setBorders(borderDictionary);
        beforeAccount();

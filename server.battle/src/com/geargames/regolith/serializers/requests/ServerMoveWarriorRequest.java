...
public class ServerMoveWarriorRequest extends ServerRequest {
    ...
    public List<MessageToClient> request(MicroByteBuffer from, MicroByteBuffer to, Client client) throws RegolithException {
        ...
        if (warriorGroup != null) {
            ...
            Warrior unit = BattleServiceRequestUtils.getWarriorFromGroup(warriorGroup, warriorId);
            if (unit != null) {
                ...
                final BattleAlliance warriorAlliance = unit.getBattleGroup().getAlliance();
                ...
                MoveOneStepListener listener = new MoveOneStepListener() {
                    ...
                    public void onStep(Warrior warrior, int x, int y) {
                        int nx = warrior.getCellX() + x;
                        int ny = warrior.getCellY() + y;
                ...
                ServerWarriorCollection enemies = (ServerWarriorCollection) WarriorHelper.move(cells, unit, x, y, listener, regolithConfiguration.getBattleConfiguration());

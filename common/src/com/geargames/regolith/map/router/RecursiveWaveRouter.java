    ...
    private void tryNeighbours(BattleCell[][] cells, int x, int y, int radius, int direction) {
        ...
        if (x + 1 < length && ((direction & RIGHT) == 0)) {
            ...
            if (BattleMapHelper.setOrder(cell0, order)) {
                tryNeighbours(cells, x + 1, y, radius - 1, LEFT_TOP | LEFT | LEFT_BOTTOM);
            }
        }
        ...
        if (x - 1 >= 0 && ((direction & LEFT) == 0)) {
            ...
            if (BattleMapHelper.setOrder(cell1, order)) {
                tryNeighbours(cells, x - 1, y, radius - 1, RIGHT | RIGHT_TOP | RIGHT_BOTTOM);
            }
        }
        ...
        if (y + 1 < length && ((direction & BOTTOM) == 0)) {
            ...
            if (BattleMapHelper.setOrder(cell2, order)) {
                tryNeighbours(cells, x, y + 1, radius - 1, RIGHT_TOP | TOP | LEFT_TOP);
            }
        }
        ...
        if (y - 1 >= 0 && ((direction & TOP) == 0)) {
            ...
            if (BattleMapHelper.setOrder(cell3, order)) {
                tryNeighbours(cells, x, y - 1, radius - 1, LEFT_BOTTOM | BOTTOM | RIGHT_BOTTOM);
            }
        }

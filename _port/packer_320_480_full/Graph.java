...
//Thu Apr 25 14:55:20 MSK 2013 , version: 108
...
public class Graph {
    ...
    final static public int FRAMES_COUNT = 1631;
    final static public int SPR_COUNT = 324;
    final static public int ANIM_COUNT = 1;
    final static public int UNIT_COUNT = 660;
    final static public int UNITS_COUNT = 181;
    final static public int OBJECTS_COUNT = 102;
    final static public int AFFINES_COUNT = 177;
...
//Frame
    ...
    final static public byte MAN_1_DIR_1_BODY = 11;
    final static public byte MAN_1_DIR_2_BODY = 24;
    final static public byte MAN_1_DIR_3_BODY = 34;
    final static public byte MAN_1_DIR_4_BODY = 45;
    final static public byte MAN_1_DIR_5_BODY = 55;
    final static public byte MAN_1_DIR_6_BODY = 67;
    final static public byte MAN_1_DIR_7_BODY = 78;
    final static public byte MAN_DIR_8_BODY = 89;
    final static public byte MAN_1_DIR_1_HEAD = 99;
    final static public byte MAN_1_DIR_2_HEAD = 104;
    final static public byte MAN_1_DIR_3_HEAD = 108;
    final static public byte MAN_1_DIR_4_HEAD = 114;
    final static public byte MAN_1_DIR_5_HEAD = 118;
    final static public byte MAN_1_DIR_6_HEAD = 124;
    final static public short MAN_1_DIR_7_HEAD = 128;
    final static public short MAN_1_DIR_8_HEAD = 134;
    final static public short MAN_1_DIR_1_FOOT = 138;
    final static public short MAN_1_DIR_2_FOOT = 187;
    final static public short MAN_1_DIR_3_FOOT = 240;
    final static public short MAN_1_DIR_4_FOOT = 301;
    final static public short MAN_1_DIR_5_FOOT = 340;
    final static public short MAN_1_DIR_6_FOOT = 392;
    final static public short MAN_1_DIR_7_FOOT = 438;
    final static public short MAN_1_DIR_8_FOOT = 498;
    final static public short MAN_1_DIR_1_ARM = 541;
    final static public short MAN_1_DIR_2_ARM = 596;
    final static public short MAN_1_DIR_3_ARM = 683;
    final static public short MAN_1_DIR_4_ARM = 759;
    final static public short MAN_1_DIR_5_ARM = 830;
    final static public short MAN_1_DIR_6_ARM = 918;
    final static public short MAN_1_DIR_7_ARM = 976;
    final static public short MAN_1_DIR_8_ARM = 1040;
    final static public short MAN_1_DIR_1_WEAPON = 1081;
    final static public short MAN_1_DIR_2_WEAPON = 1097;
    final static public short MAN_1_DIR_3_WEAPON = 1109;
    final static public short MAN_1_DIR_4_WEAPON = 1128;
    final static public short MAN_1_DIR_5_WEAPON = 1143;
    final static public short MAN_1_DIR_6_WEAPON = 1168;
    final static public short MAN_1_DIR_7_WEAPON = 1183;
    final static public short MAN_1_DIR_8_WEAPON = 1189;
    final static public short EL_HINT = 1494;
    final static public short EL_FONT = 1503;
//Sprite
    final static public byte SPR_EMPTY = 0;
    final static public byte SPR_GROUND = 1;
    final static public byte SPR_DISTANCE = 2;
    final static public byte SPR_BOTTON = 12;
    final static public byte SPR_RIFLE_DIR_6 = 30;
    final static public byte SPR_SHADOW = 32;
    final static public byte SPR_PICTURE_BACK = 40;
    final static public byte SPR_TEST = 41;
    final static public byte SPR_PANEL_BACK = 44;
    final static public byte SPR_PANEL_FRAME = 57;
    final static public byte SPR_SUB_PANEL = 65;
    final static public byte SPR_SIDE = 67;
    final static public byte SPR_PANEL_TOP_LEFT = 71;
    final static public byte SPR_PANEL_TOP_CENTRE = 72;
    final static public byte SPR_PANEL_TOP_RIGHT = 73;
    final static public byte SPR_TEAM_COLOR = 88;
    final static public byte SPR_SKILL_ICO = 95;
    final static public byte SPR_CHARACTER_IND = 103;
    final static public byte SPR_SKILL_IND = 114;
    final static public short SPR_ICO_LIFE_IND = 135;
    final static public short SPR_BUTTON = 143;
    final static public short SPR_ICO_WEAPON = 209;
    final static public short SPR_TEXT_TEST = 223;
    final static public short SPR_FONT_SYMB = 225;
    final static public short SPR_FONT_NUM = 241;
    final static public short SPR_FONT_EN = 258;
    final static public short SPR_FONT_RU = 290;
//Animation
//Unit
...
//Object
    ...
    final static public byte PAN_MAIN_MENU = 8;
    final static public byte PAN_TYPE_BATTLE = 9;
    final static public byte PAN_FIGHTER = 10;
    final static public byte PAN_FIGHTER_INFO = 11;
    final static public byte PAN_WEAPON_SELECT = 12;
    final static public byte PAN_BATTLE_LIST = 13;
    final static public byte PAN_BATTLE_CREATE = 14;
    final static public byte PAN_PLAYER_INFO = 15;
    final static public byte PAN_FIGHTER_SELECT = 16;
    final static public byte PAN_MAP_SELECT = 17;
    final static public byte PAN_LEFT = 18;
    final static public byte PAN_CENTER = 19;
    final static public byte PAN_RIGHT = 20;
    final static public byte PAN_WAITING_SERVER = 21;
    final static public byte PAN_BAT_MENU = 22;
    final static public byte PAN_BAT_WEAPON = 23;
    final static public byte PAN_BAT_SEL_FIGHTER = 24;
    final static public byte PAN_BAT_FIGHTER = 25;
    final static public byte PAN_BAT_FIRE = 26;
    final static public byte OBJ_SUBPANEL_WEAPON_LEFT = 27;
    final static public byte OBJ_LIST_WEAPON_ITEM = 28;
    final static public byte OBJ_LIST_BATTLE_ITEM = 29;
    final static public byte OBJ_LIST_WEAPON = 30;
    final static public byte OBJ_LIST_BATTLE = 31;
    final static public byte OBJ_LIST_FIGHTER = 32;
    final static public byte OBJ_LIST_REWARD = 33;
    final static public byte OBJ_LIST_FIGHTER_FACE = 34;
    final static public byte OBJ_LIST_MAP = 35;
    final static public byte OBJ_REWARD_AVA_BIG = 36;
    final static public byte OBJ_PLAYER_AVA_BIG = 37;
    final static public byte OBJ_PLAYER_AVA_SMALL = 38;
    final static public byte OBJ_MAP_MINI = 39;
    final static public byte OBJ_FIGHTER_SMALL = 40;
    final static public byte OBJ_BAT_FIGHTER = 41;
    final static public byte OBJ_SIDE = 42;
    final static public byte OBJ_BATTLE = 46;
    final static public byte OBJ_IND_HEALTH = 47;
    final static public byte OBJ_IND_1 = 48;
    final static public byte OBJ_IND_CHARACTER = 49;
    final static public byte OBJ_IND_SKILL = 50;
    final static public byte OBJ_LABEL_MONEY = 51;
    final static public byte OBJ_LABEL_PLAYER_INFO = 52;
    final static public byte OBJ_BUT_LATER = 53;
    final static public byte OBJ_BUT_PREVISION = 54;
    final static public byte OBJ_BUT_BACK = 55;
    final static public byte OBJ_BUT_RADIO = 56;
    final static public byte OBJ_BUT = 66;
    final static public byte OBJ_BUT_SELECT = 67;
    final static public byte OBJ_BUT_BATTLE = 69;
    final static public byte OBJ_BUT_KICK = 71;
    final static public byte OBJ_BUT_PLAYER_INFO = 76;
    final static public byte OBJ_BUT_WIEW = 78;
    final static public byte OBJ_BUT_BATTLE_MENU = 80;
    final static public byte OBJ_CHECKBOX = 87;
    final static public byte OBJ_CHECKBOX_STRING = 88;
    final static public byte OBJ_BUT_PLUS = 89;
    final static public byte OBJ_SPINBOX = 91;
    final static public byte OBJ_HINT = 92;
    final static public byte MENU_COMMON = 93;
    final static public byte MENU_COMMON_ITEM = 94;
    final static public byte MENU_COMMON_CONFIRM = 95;
    final static public byte MENU_BOTTON_YES = 96;
    final static public byte MENU_BOTTON_NO = 97;
    final static public byte MENU_BOTTON_MENU = 98;
    final static public byte MENU_TEST = 99;
    final static public byte MENU_TEST_2 = 100;
    final static public byte OBJ_PANEL_TOP_TEST = 101;
//Location
//Map
//PColor
//GAI
...
//Emitter
//Affine
    final static public byte AF_ARM_DIR_1 = 8;
    final static public byte AF_ARM_DIR_3 = 16;
    final static public byte AF_ARM_DIR_4 = 18;
    final static public byte AF_ARM_DIR_5 = 20;
    final static public byte AF_ARM_DIR_6 = 22;
    final static public byte AF_ARM_DIR_7 = 25;
    final static public byte AF_ARM_DIR_8 = 34;
    final static public byte AF_FOOT_DIR_1 = 36;
    final static public byte AF_FOOT_DIR_2 = 37;
    final static public byte AF_FOOT_DIR_3 = 41;
    final static public byte AF_FOOT_DIR_5 = 42;
    final static public byte AF_FOOT_DIR_6 = 43;
    final static public byte AF_FOOT_DIR_8 = 44;
    final static public byte AF_BODY_DIR_1 = 46;
    final static public byte AF_BODY_DIR_3 = 52;
    final static public byte AF_BODY_DIR_5 = 53;
    final static public byte AF_BODY_DIR_6 = 55;
    final static public byte AF_BODY_DIR_7 = 57;
    final static public byte AF_BODY_DIR_8 = 65;
    final static public byte AF_HEAD_DIR_1 = 70;
    final static public byte AF_HEAD_DIR_5 = 72;
    final static public byte AF_HEAD_DIR_7 = 73;
    final static public byte AF_WEAPON_DIR_1 = 74;
    final static public byte AF_RUN = 101;
    final static public byte AF_WEAPON_DIR_3 = 113;
    final static public short AF_WEAPON_DIR_4 = 159;
    final static public short AF_WEAPON_DIR_5 = 161;
    final static public short AF_WEAPON_DIR_6 = 163;
    final static public short AF_WEAPON_DIR_7 = 171;
    final static public short AF_WEAPON_DIR_8 = 175;
     final static int[] COLOR = {0, 65535, };
    static public int getCOLOR(int i){return COLOR[i];};

//Links
    final static public byte Frame_I_ID = 0;//1631
    final static public byte Frame_I_TYPE = 1;//1631
    final static public byte Sprite_index_I_TYPE = 2;//1181
    ...
    final static public byte Object_index_I_W = 7;//516
    final static public byte Object_index_I_H = 8;//516
    final static public byte Object_index_I_TYPE = 9;//516
    final static public byte Object_index_I_LAYER_TYPE = 10;//516
    final static public byte Object_index_I_SLOT = 11;//516
    ...
    final static public byte Affine_I_AF_TR = 16;//177
    final static public byte Affine_I_AF_SC_X = 17;//177
    final static public byte Affine_I_AF_SC_Y = 18;//177
    final static public byte Affine_I_AF_HM = 19;//177
    final static public byte Affine_I_AF_VM = 20;//177
    final static public byte PARAM_BYTE_COUNT = 21;

    final static public byte Frame_I_X = 21;//1631
    final static public byte Frame_I_Y = 22;//1631
    final static public byte Frame_I_W = 23;//1631
    final static public byte Frame_I_H = 24;//1631
    final static public byte Sprite_I_X = 25;//324
    final static public byte Sprite_I_Y = 26;//324
    final static public byte Sprite_index_I_ID = 27;//1181
    final static public byte Sprite_index_I_X = 28;//1181
    final static public byte Sprite_index_I_Y = 29;//1181
    ...
    final static public byte Object_I_X = 45;//102
    final static public byte Object_I_Y = 46;//102
    final static public byte Object_index_I_ID = 47;//516
    final static public byte Object_index_I_X = 48;//516
    final static public byte Object_index_I_Y = 49;//516
    ...
    final static public byte Affine_I_X = 55;//177
    final static public byte Affine_I_Y = 56;//177
    final static public byte Affine_I_AF_RO = 57;//177
    final static public byte Affine_index_I_ID = 58;//177
    final static public byte Affine_index_I_X = 59;//177
    final static public byte Affine_index_I_Y = 60;//177
